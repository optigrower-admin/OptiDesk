...
const ETAPAS_VENTA = ['nuevo', 'con_interes', 'con_objecion', 'seguimiento', 'buscando_credito', 'calificado', 'ganado', 'en_matricula', 'alistamiento', 'espera_entrega', 'entregada', 'perdido']
