export type EtapaVenta =
  | 'nuevo' | 'calificado' | 'demo' | 'propuesta' | 'negociacion' | 'ganado'
...
export const ETAPA_ORDEN: Record<EtapaVenta, number> = {
  nuevo: 0, calificado: 1, demo: 2, propuesta: 3, negociacion: 4, ganado: 5,
  en_matricula: 6, alistamiento: 7, espera_entrega: 8, entregada: 9, perdido: 10,
}
