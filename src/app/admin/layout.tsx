...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/integraciones/progreser', label: 'Progreser',         seccion: 'integraciones_progreser', soloGerencia: false, rolesPermitidos: ['gerencia', 'dueno', 'control_total', 'admin'], defaultOrden: 325 },
    ],
  },
  {
    key: 'consultas-sql',
